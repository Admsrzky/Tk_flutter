...
import 'package:tk_online_flutter/screens/add_product.dart';
import 'package:tk_online_flutter/screens/edit_product.dart';
import 'dart:convert';

import 'package:tk_online_flutter/screens/product_detail.dart';
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            return Text("Load data, Silahkan Cek Xampp mu :)");
          }
        },
      ),
    );
